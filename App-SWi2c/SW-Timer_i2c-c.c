            ...
            if(sw_state == 0) {
                ...
                if (dot_timer != NULL) {
                    ...
                    if (phrase_timer != NULL) {
                        xTimerChangePeriod(dot_timer, phrase_timer_period, 0);  // set dot length, start timer
                        // xQueueReceive signals end of timed interval
                        xQueueReceive(xQdot, &timer_info, portMAX_DELAY); 
                        printf(" ** System2 ON ** %x\n",delay_state);               
//                        show_seven_seg_i2c(delay_state);
...
//   0B0000|0000|0010|0001|0000|1000|0000|0000  16,11 
    const uint32_t dot_mask = 0x00010800;
//   0B0000|0000|0000|1110|0000|0000|0000|0000  19,18,17 
    ...
    sleep_ms(2000);
     ...
     // Configure LED DOTS
    gpio_init_mask(dot_mask);  // 11, 16 DOTL, DOTR
